...
def toSimbaSettings(genome):
    ...
    return f'{{"queue": [{queue}], "jobQueue": [{jobQueue}], "geneticAlgorithm": true, "speed": 4096, "disableTimeskip": true, "desiredTicksPerLoop": 16, "running": true, "autoHunt": true, "autoSteel": true}}'
